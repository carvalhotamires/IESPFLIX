...
public class PalavrasBloqueadasValidator implements ConstraintValidator<PalavrasBloqueadas, String> {
    ...
    private static final List<String> PALAVRAS_BLOQUEADAS = Arrays.asList(
            "sexo", "drogas", "violência", "pornô", "xxx", "nazista", "racista",
            "terrorismo", "ódio", "assassinato", "morte", "genocídio", "pedofilia", "estuprador",
            "estupro", "tortura", "agressão", "brutalidade", "explícito", "perversão",
            "obsceno", "adulto", "tabu", "ilegal", "contrabando", "armas", "tiroteio",
            "sangue", "gore", "selvageria", "crueldade", "massacre", "traficante", "trafico",
            "banido", "proibido", "maldito", "blasfêmia", "satânico", "demoníaco",
            "prostituição", "prostituta", "vadiagem", "corrupto", "corrupção", "crime",
            "criminoso", "máfia", "gangue"
    );
